...
import { getOrganizerClubs } from '../../services/organizer.service';
import type { ClubItem } from '../../types/club';
import { handleApiError } from '../../utils/errorHandler';

export const OrganizerClubsScreen = () => {
  ...
  return (
    ...
    >
      <AppHeader
        title="My Clubs"
        subtitle="Manage membership structures for the clubs where you are a manager or member."
      />
      ...
      {!loading && !errorMessage && !clubs.length ? (
        <EmptyState
          title="No club memberships found"
          message="Your club memberships will appear here once they are available from the backend."
        />
      ) : null}
      ...
      <View style={styles.list}>
        {clubs.map((club) => (
          <ClubCard
            ...
            club={club}
            onPress={() =>
              navigation.navigate(ORGANIZER_STACK_ROUTES.ClubMembers, {
                clubId: club.id,
                clubName: club.name,
              })
            }
