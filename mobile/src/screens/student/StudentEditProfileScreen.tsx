...
import { type StudentStackParamList } from '../../constants/routes';
...
type Props = NativeStackScreenProps<StudentStackParamList, 'StudentEditProfile'>;

export const StudentEditProfileScreen = ({ navigation }: Props) => {
  ...
  return (
    <ScreenContainer>
      <AppHeader title="Edit Profile" onBackPress={() => navigation.goBack()} />
      <Controller
        control={control}
        name="full_name"
